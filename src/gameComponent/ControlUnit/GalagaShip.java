...
public class GalagaShip extends ControlUnit {
	...
	public static final double PLATFORM_Y_LOC = 9.0/10;
	
	public static final String SHIP_IMAGE = "resources/galagaShip.png";
	
	public GalagaShip(int canvasSize){
		super(SHIP_IMAGE, canvasSize, canvasSize * PLATFORM_X_LOC - PLATFORM_HALF_WIDTH, PLATFORM_Y_LOC * canvasSize, SHIP_WIDTH);
	}
